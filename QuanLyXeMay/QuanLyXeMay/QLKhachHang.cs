...
namespace QuanLyXeMay
{
    public partial class QLKhachHang : Form
    {
        ...
        public QLKhachHang()
        {
            ...
            InitializeComponent();
            this.Load += new EventHandler(QLKhachHang_Load);
            this.SizeChanged += new EventHandler(QLKhachHang_SizeChanged);
        }
        ...
        private void QLKhachHang_Load(object sender, EventArgs e)
        {
            ...
            this.Text = "Xemaytot.com | Quản lý khách hàng";
            ...
            flowLayoutTopRight.Controls.Add(CreateView.CreateInput("Tên khách hàng", txtTenKH));
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            if (storageImage(path, fileName))
            {
                ...
                List<NguoiDung> listKH = nguoiDungDAO.GetUserByKeyword(txtSearch.Text, loaiSearch, "nguoidung", page, size);
                dataGridView.DataSource = listKH;
        ...
        private void QLKhachHang_SizeChanged(object sender, EventArgs e)
        {
            UpdateControlsPosition();
        }
